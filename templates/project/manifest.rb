...
stylesheet 'partials/02-mixins/_custom.scss'
stylesheet 'partials/03-extend/_all.scss'
stylesheet 'partials/03-extend/_helpers.scss'
stylesheet 'partials/03-extend/_typography.scss'
stylesheet 'partials/04-base/_all.scss'
stylesheet 'partials/04-base/_common.scss'
stylesheet 'partials/04-base/_edits.scss'
stylesheet 'partials/04-base/_font-face.scss'
stylesheet 'partials/04-base/_headers.scss'
stylesheet 'partials/04-base/_images.scss'
stylesheet 'partials/04-base/_semantics.scss'
stylesheet 'partials/04-base/_tables.scss'
stylesheet 'partials/04-base/_form-defaults.scss'
stylesheet 'partials/05-layout/_grids-susy.scss'
stylesheet 'partials/06-ui-patterns/_common.scss'
stylesheet 'partials/06-ui-patterns/_drupal-patterns.scss'
stylesheet 'partials/07-styletile/_tile-design.scss'
stylesheet 'partials/08-media/_print.scss'
stylesheet 'your-design-here/_design.scss'
...
image 'formalize/button.png'
image 'formalize/select_arrow.gif'
